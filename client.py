...
def connect(hostname, port, client_cert, client_key, server_cert, authenticate_client):
...
if __name__ == '__main__':
    ...
    parser.add_argument('authenticate_client', type=str, help="Type 'False' for one-way auth, type anything else for 2-way")
    ...
    while True:
        try:
            sock = connect(args.serv_addr, args.serv_port, args.cert, args.key, args.serv_cert, args.authenticate_client)
        except Error as e:
            print(e)
            sys.exit(1)
        try:
