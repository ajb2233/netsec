...
def listen(port, server_cert, server_key, client_cert, authenticate_client):
...
if __name__ == '__main__':
    ...
    try:
        sock = listen(args.port, args.cert, args.key, args.clnt_cert, args.authenticate_client)
    except Error as e:
        print(str(e))
        sys.exit(1)
    else:
